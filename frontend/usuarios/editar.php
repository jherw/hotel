...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar usuarios | Hotel "MI CIELO"</title>
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="../usuarios/mostrar.php" class="current-page">Usuarios</a>
										</li>
										<li>
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
								...
								<div class="card m-0">
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nombre; ?>" name="uxnam" placeholder="Nombre" required="">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="email" class="form-control" value="<?php echo $d->correo; ?>"  name="uxem" placeholder="Correo" required="">
												</div>
											</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->usuario; ?>"  name="uxuse" placeholder="Nombre de usuario" required="">
												</div>
											</div>
											
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<select class="form-control" name="uxrul">
														<option value="<?php echo $d->rol; ?>"><?php echo $d->rol; ?></option>
										...
										<button  name="up_usr" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_usr.php'
?>
	</body>
</html>
