...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Nuevos usuarios | Hotel "MI CIELO"</title>
	...
	<body>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Nuevos usuarios</li>
					</ol>
				</div>
				<!-- Page header end -->
								...
								<div class="card m-0">
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" name="uxnam" placeholder="Nombre" required="">
												</div>
											</div>

											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="email" class="form-control"  name="uxem" placeholder="Correo" required="">
												</div>
											</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control"  name="uxuse" placeholder="Nombre de usuario" required="">
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="password" class="form-control"  name="uxcon" placeholder="Contraseña" required="">
												</div>
											</div>
										</div>
		...
		<?php
    include_once '../../backend/php/add_usr.php'
?>
	</body>
</html>
