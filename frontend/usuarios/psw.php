...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Contraseña usuarios | Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Contraseña usuarios</li>
					</ol>
				</div>
				<!-- Page header end -->
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar contraseña de usuarios</div>
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="password" class="form-control" name="uxpsw" placeholder="Nueva contraseña" required="">
										...
										<button  name="up_psw" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_psw.php'
?>
	</body>
</html>
