...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Perfil de la cuenta | Hotel "MI CIELO"</title>
									...
									<div class="row gutters">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="<?php echo $_SESSION['nombre']; ?>" readonly id="fullName" placeholder="Enter full name">
											</div>
											<div class="form-group">
												<label for="eMail">Correo</label>
												<input type="email" class="form-control" readonly value="<?php echo $_SESSION['correo']; ?>" id="eMail" placeholder="Enter email ID">
											</div>
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="phone" readonly value="<?php echo $_SESSION['usuario']; ?>" placeholder="Enter phone number">
											</div>
											<div class="form-group">
												<label for="website">Rol</label>
												<input type="url" class="form-control" id="website" readonly value="Administrador" placeholder="Website url">
											</div>
										</div>
