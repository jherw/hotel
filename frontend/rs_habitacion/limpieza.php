						...
						<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
							<div class="card h-100">
								<div class="card-header">
									<div class="card-title">Finalizar limpieza</div>
								</div>
								
								<?php 

 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT habitaciones.idhab, habitaciones.numiha, habitaciones.detaha, habitaciones.precha, pisos.idps, pisos.nompis, hcate.idhc, hcate.nomhc, habitaciones.estadha FROM habitaciones INNER JOIN pisos ON habitaciones.idps =pisos.idps INNER JOIN hcate ON habitaciones.idhc =hcate.idhc  WHERE habitaciones.idhab= '$id' GROUP BY habitaciones.estadha;");
 $sentencia->execute();
									...
									<div class="row gutters">
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="hidden" name="lcha" value="<?php echo $d->idhab; ?>">
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="text-right">
												...
												<button type="submit" name="upd_lim" class="btn btn-primary">Finalizar limpieza</button>
											</div>
										</div>
									</div>
							</form>
...
<!-- MODAL-ELIMINAR -->
		...
		<?php
    include_once '../../backend/php/upd_lim.php'
?>
