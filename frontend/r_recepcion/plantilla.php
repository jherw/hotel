...
$pdf->Cell(90, 12, utf8_decode('Cliente'),1,0,'C',1);
$pdf->Cell(45, 12, utf8_decode('Nº habitación'),1,0,'C',1);
$pdf->Cell(100, 12, utf8_decode('Detalle de la habitación'),1,0,'C',1);
$pdf->Cell(40, 12, utf8_decode('Precio de la habitación'),1,1,'C',1);
...
$pdf->Cell(90, 8, utf8_decode($row['nomc']),'B',0,'C',1);
$pdf->Cell(45, 8, utf8_decode($row['numiha']),'B',0,'C',1);
$pdf->Cell(100, 8, utf8_decode($row['detaha']),'B',0,'C',1);
