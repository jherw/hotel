...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar productos| Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Actualizar productos</li>
					</ol>
				</div>
				<!-- Page header end -->
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar productos</div>
									...
									<div class="card-body">
										<div class="row gutters">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nomprd; ?>"  name="prdnam" placeholder="Nombre del producto">
												</div>
											</div>

											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
												<select class="form-control" id="cat" name="prdcat">
													...
													<?php
													$stmt = $connect->prepare('SELECT * FROM categorias'); 
													 $stmt->execute();
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->numprd; ?>" maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  name="prdcod" placeholder="Código del producto" >
													<input type="hidden" name="idprd" value="<?php echo $d->idprd; ?>" />
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->preprd; ?>"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="prdpre" placeholder="Precio del producto">
												</div>
											</div>
										</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" disabled class="form-control" value="<?php echo $d->stckprd; ?>" maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  placeholder="Stock del producto">
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<select class="form-control" name="prdsta" disabled>
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<textarea class="form-control"   name="prddet" value="<?php echo $d->detprd; ?>" placeholder="Detalle del producto" maxlength="299" rows="3"><?php echo $d->detprd; ?></textarea>
										...
										<button  name="up_prd" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_prd.php'
?>
