...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar stock productos| Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Actualizar stock productos</li>
					</ol>
				</div>
				<!-- Page header end -->
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Control de stock de productos</div>
									...
									<div class="card-body">
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" name="prdsto" class="form-control" value="<?php echo $d->stckprd; ?>" maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  placeholder="Stock del producto">
										...
										<button  name="up_prdst" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_prdstc.php'
?>
