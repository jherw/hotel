...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar clientes| Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Actualizar clientes</li>
					</ol>
				</div>
				<!-- Page header end -->
...
require '../../backend/config/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM clientes  WHERE iddn= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar clientes</div>
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												...
												<select class="form-control" name="cxtip" >
													<option value="<?php echo $d->dnic; ?>"><?php echo $d->dnic; ?></option>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->numc; ?>" maxlength="14"  name="cxdoc" placeholder="Nº de documento" >
													<input type="hidden" name="iddn" value="<?php echo $d->iddn; ?>" />
												</div>
											</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nomc; ?>"  name="cxna" placeholder="Nombres" >
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->apec; ?>" name="cxap" placeholder="Apellidos" >
												</div>
											</div>
										</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="email" class="form-control" value="<?php echo $d->corrc; ?>"  name="cxema" placeholder="Correo electrónico">
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" >
												<div class="form-group">
													<select class="form-control" name="cxsta" disabled>
										...
										<button  name="up_cli" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_cli.php'
?>
	</body>
</html>
