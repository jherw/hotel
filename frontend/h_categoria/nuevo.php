...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Nuevas categorias | Hotel "MI CIELO"</title>
	...
	<body>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Nuevas categorias del hotel</li>
					</ol>
				</div>
				<!-- Page header end -->
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Nuevas categorias</div>
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" name="chnam" placeholder="Nombre" required="">
												</div>
											</div>

											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<select class="form-control" name="chsta">
		...
		<?php
    include_once '../../backend/php/add_chadd.php'
?>
	</body>
</html>
