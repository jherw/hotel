			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Categoria del hotel</li>
					</ol>
				</div>
				<!-- Page header end -->
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="table-container">
								<div class="t-header">Categoria del hotel</div>
...
$sentencia = $connect->prepare("SELECT * FROM hcate ORDER BY idhc DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
	...
	<div class="btn-group">
												...
												<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
													<a class="dropdown-item" href="../h_categoria/editar.php?id=<?php echo $d->idhc ?>">Editar</a>
													<a class="dropdown-item" href="../h_categoria/eliminar.php?id=<?php echo $d->idhc ?>">Eliminar</a>
