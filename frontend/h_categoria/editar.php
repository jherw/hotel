							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="../h_categoria/mostrar.php" class="current-page">Categoria</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Categorias del hotel</li>
						<li class="breadcrumb-item active">Actualizar categorias del hotel</li>
					</ol>
				</div>
				<!-- Page header end -->
...
require '../../backend/config/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM hcate  WHERE idhc= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar categorias del hotel</div>
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nomhc; ?>" name="chnam" placeholder="Nombre" required="">
													<input type="hidden" name="chid" value="<?php echo $d->idhc; ?>" />
												</div>
											</div>
										...
										<button  name="up_cat" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_chcat.php'
?>
	</body>
</html>
