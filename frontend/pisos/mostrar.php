...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Pisos | Hotel "MI CIELO"</title>
...
$sentencia = $connect->prepare("SELECT * FROM pisos ORDER BY idps DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
	...
	<div class="btn-group">
												...
												<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
													<a class="dropdown-item" href="../pisos/editar.php?id=<?php echo $d->idps ?>">Editar</a>
													<a class="dropdown-item" href="../pisos/eliminar.php?id=<?php echo $d->idps ?>">Eliminar</a>
