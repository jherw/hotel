...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar pisos| Hotel "MI CIELO"</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="../pisos/mostrar.php" class="current-page">Pisos</a>
										</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">Pisos</li>
						<li class="breadcrumb-item active">Actualizar pisos</li>
					</ol>
				</div>
				<!-- Page header end -->
...
require '../../backend/config/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM pisos  WHERE idps= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar pisos</div>
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nompis; ?>"  name="pxnam" placeholder="Nombre del piso">
													<input type="hidden" name="pxid" value="<?php echo $d->idps; ?>">
												</div>
											</div>
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" >
												<div class="form-group">
										...
										<button  name="up_pis" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_pis.php'
?>
	</body>
</html>
