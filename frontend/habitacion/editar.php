...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar habitación | Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Actualizar habitaciones</li>
					</ol>
				</div>
				<!-- Page header end -->
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
							...
							<form enctype="multipart/form-data" method="POST" action="" autocomplete="off">
								<div class="card m-0">
									<div class="card-header">
										<div class="card-title">Actualizar habitaciones</div>
									...
									<div class="card-body">
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" maxlength="3" value="<?php echo $d->numiha	 ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control" name="hnum" placeholder="Número de la habitación">
													<input type="hidden" name="hidx" value="<?php echo $d->idhab	 ?>">
												</div>
											</div>
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												...
												<select class="form-control" id="pis"  name="hpis" required>
													<option value="<?php echo $d->idps	 ?>"><?php echo $d->nompis ?></option>
													<option>-----------------</option>

													<?php
													$stmt = $connect->prepare('SELECT * FROM pisos'); 
													 $stmt->execute();
										...
										<div class="row gutters">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												...
												<select class="form-control" id="cat" name="hcat" required>
													<option value="<?php echo $d->idhc ?>"><?php echo $d->nomhc ?></option>
													<option>-----------------</option>

													<?php
													$stmt = $connect->prepare('SELECT * FROM hcate'); 
													 $stmt->execute();
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $d->precha ?>" class="form-control" name="hpre" placeholder="Precio de la habitación" required="">
												</div>
											</div>
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<textarea class="form-control" value="<?php echo $d->detaha ?>" name="hdet" id="message" placeholder="Detalle de la habitación"  rows="3"><?php echo $d->detaha ?></textarea>
										...
										<button  name="up_ha" type="submit" class="btn btn-primary float-right">Guardar</button>
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_chabi.php'
?>
	</body>
</html>
