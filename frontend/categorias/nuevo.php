...
<html lang="es">
	...
	<body>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Nuevas categorias</li>
					</ol>
				</div>
				<!-- Page header end -->
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" name="ctnam" placeholder="Nombre" required="">
												</div>
											</div>
		...
		<?php
    include_once '../../backend/php/add_catne.php'
?>
	</body>
</html>
