							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="../categorias/mostrar.php" class="current-page">Categorias</a>
										</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Actualizar categorias</li>
					</ol>
				</div>
				<!-- Page header end -->
...
require '../../backend/config/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM categorias  WHERE idcat= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="text" class="form-control" value="<?php echo $d->nomcat; ?>" name="ctnam" placeholder="Nombre" required="">
    ...
    <?php endif; ?>
		...
		<?php
    include_once '../../backend/php/upd_cat.php'
?>
	</body>
</html>
