...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Ventas de productos | Hotel "MI CIELO"</title>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Ventas de productos</li>
					</ol>
				</div>
				<!-- Page header end -->
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="table-container">
								<div class="t-header">Ventas de productos</div>
...
$sentencia = $connect->prepare("SELECT orders.idord, clientes.iddn, clientes.dnic, clientes.numc, clientes.nomc, clientes.apec, orders.method, orders.total_products, orders.total_price, orders.placed_on, orders.tipc ,orders.payment_status FROM orders INNER JOIN clientes ON orders.user_cli = clientes.iddn ORDER BY idord DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
									...
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $d->tipc ?></td>
												<td><?php echo $d->placed_on ?></td>
												<td><?php echo $d->total_price ?></td>
												<td><?php echo $d->nomc ?>&nbsp;<?php echo $d->apec ?></td>
												<td><?php echo $d->total_products ?></td>
												
												<td><span class="badge badge-primary"><?php echo $d->payment_status ?></span></td>
											...
											<div class="btn-group">
												...
												<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
													<a class="dropdown-item" href="../venta/boleta.php?id=<?php echo $d->idord ?>">Boleta</a>
													<a class="dropdown-item" href="../venta/ticket.php?id=<?php echo $d->idord ?>">Ticket</a>
